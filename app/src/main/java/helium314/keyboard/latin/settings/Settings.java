...
public final class Settings implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String PREF_FLICK_REBOUND = "flick_rebound";
    public static final String PREF_FLICK_REBOUND_STRENGTH = "flick_rebound_strength";
    public static final String PREF_KEY_PRESS_SCALE = "key_press_scale";
    public static final String PREF_KEY_PRESS_LABEL_SCALE = "key_press_label_scale";
    public static final String PREF_KEY_PRESS_ANIM_DURATION = "key_press_anim_duration";
    public static final String PREF_KEY_RELEASE_ANIM_DURATION = "key_release_anim_duration";
    public static final String PREF_KEY_PRESS_EASING = "key_press_easing";
    public static final String PREF_KEY_PRESS_HIGHLIGHT = "key_press_highlight";
