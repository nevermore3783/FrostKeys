...
object Defaults {
    ...
    const val PREF_SPACEBAR_TRACKPAD_LINE_SNAP = true
    const val PREF_SPACEBAR_TRACKPAD_LONG_PRESS = true
    const val PREF_SPACE_PRESS_SCALE = 100
    const val PREF_SPACE_PRESS_LABEL_SCALE = 100
