...
public class SettingsValues {
    ...
    public final boolean mFlickRebound;
    public final int mFlickReboundStrength;
    public final int mKeyPressScale;
    public final int mKeyPressLabelScale;
    public final int mKeyPressAnimDuration;
    public final int mKeyReleaseAnimDuration;
    public final int mKeyPressEasing;
    public final int mKeyPressHighlight;
    ...
    public final boolean mSpacebarTrackpadLineSnap;
    public final boolean mSpacebarTrackpadLongPress;
    public final int mSpacePressScale;
    public final int mSpacePressLabelScale;
    ...
    public SettingsValues(final Context context, final SharedPreferences prefs, final Resources res,
        ...
        mFlickRebound = prefs.getBoolean(Settings.PREF_FLICK_REBOUND, Defaults.PREF_FLICK_REBOUND);
        mFlickReboundStrength = prefs.getInt(Settings.PREF_FLICK_REBOUND_STRENGTH, Defaults.PREF_FLICK_REBOUND_STRENGTH);
        mKeyPressScale = prefs.getInt(Settings.PREF_KEY_PRESS_SCALE, Defaults.PREF_KEY_PRESS_SCALE);
        mKeyPressLabelScale = prefs.getInt(Settings.PREF_KEY_PRESS_LABEL_SCALE, Defaults.PREF_KEY_PRESS_LABEL_SCALE);
        mKeyPressAnimDuration = prefs.getInt(Settings.PREF_KEY_PRESS_ANIM_DURATION, Defaults.PREF_KEY_PRESS_ANIM_DURATION);
        mKeyReleaseAnimDuration = prefs.getInt(Settings.PREF_KEY_RELEASE_ANIM_DURATION, Defaults.PREF_KEY_RELEASE_ANIM_DURATION);
        mKeyPressEasing = prefs.getInt(Settings.PREF_KEY_PRESS_EASING, Defaults.PREF_KEY_PRESS_EASING);
        mKeyPressHighlight = prefs.getInt(Settings.PREF_KEY_PRESS_HIGHLIGHT, Defaults.PREF_KEY_PRESS_HIGHLIGHT);
        ...
        mSpacebarTrackpadLineSnap = prefs.getBoolean(Settings.PREF_SPACEBAR_TRACKPAD_LINE_SNAP, Defaults.PREF_SPACEBAR_TRACKPAD_LINE_SNAP);
        mSpacebarTrackpadLongPress = prefs.getBoolean(Settings.PREF_SPACEBAR_TRACKPAD_LONG_PRESS, Defaults.PREF_SPACEBAR_TRACKPAD_LONG_PRESS);
        mSpacePressScale = prefs.getInt(Settings.PREF_SPACE_PRESS_SCALE, Defaults.PREF_SPACE_PRESS_SCALE);
        mSpacePressLabelScale = prefs.getInt(Settings.PREF_SPACE_PRESS_LABEL_SCALE, Defaults.PREF_SPACE_PRESS_LABEL_SCALE);
